...
> This page documents the current inherited configuration surface, not the final `ZenithForge` server contract.
...
ZenithForge primarily uses a config.yml file to adjust various options. This is the preferred way and has the ability to adjust all options of ZenithForge.
...
| ---------------------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| host                   | String (127.0.0.1)     | Set the IP address used for hosting ZenithForge                                                                            |
| port                   | Int (5000)             | Set the TCP Port use for ZenithForge                                                                                       |
...
| inline_model_loading                 | Bool (False)                     | Enables ability to switch models using the `model` argument in a generation request. More info in [Usage](https://github.com/lesj0610/ZenithForge/tree/main/docs)                                               |
