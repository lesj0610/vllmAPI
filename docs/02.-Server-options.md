...
> This page documents the current inherited configuration surface, not the final `vllmAPI` server contract.
...
vllmAPI primarily uses a config.yml file to adjust various options. This is the preferred way and has the ability to adjust all options of vllmAPI.
...
| ---------------------- | ---------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| host                   | String (127.0.0.1)     | Set the IP address used for hosting vllmAPI                                                                            |
| port                   | Int (5000)             | Set the TCP Port use for vllmAPI                                                                                       |
...
| inline_model_loading                 | Bool (False)                     | Enables ability to switch models using the `model` argument in a generation request. More info in [Usage](https://github.com/lesj0610/vllmAPI/tree/main/docs)                                               |
